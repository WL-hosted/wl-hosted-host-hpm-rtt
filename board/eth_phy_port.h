...
enum phy_link_status { PHY_LINK_DOWN = 0U, PHY_LINK_UP };
...
/* PHY0 register list */
#define PHY0_REG_LIST                                                          \
    PHY_BASIC_CONTROL_REG, PHY_BASIC_STATUS_REG, PHY_ID1_REG, PHY_ID2_REG,     \
        PHY_AUTONEG_ADVERTISE_REG, PHY_STATUS_REG

...
/* Baseline: CherryDAP/projects/HSLink-Pro/bootloader/usb_config.h. */
...
#define CONFIG_USBDEV_MSC_MANUFACTURER_STRING "BeeTackle"
#endif

#ifndef CONFIG_USBDEV_MSC_PRODUCT_STRING
#define CONFIG_USBDEV_MSC_PRODUCT_STRING "HPM UF2"
#endif
...
/* This parameter affects usb performance, and depends on (TCP_WND)tcp eceive
 * windows size, you can change to 2K ~ 16K and must be larger than TCP RX
 * windows size in order to avoid being overflow.
 */
#ifndef CONFIG_USBHOST_RNDIS_ETH_MAX_RX_SIZE
#define CONFIG_USBHOST_RNDIS_ETH_MAX_RX_SIZE (2048)
#endif

/* Because lwip do not support multi pbuf at a time, so increasing this variable
